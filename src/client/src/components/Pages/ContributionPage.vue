<template>
  <div class="cont">
    ...
    <div class="cont-desc">
        <div id="step1">
            <h2>Step 1: Get Authenticated</h2>
            <div id="content1">
                To start accessing sightings in the Acartia Database, first you need to contact Scott Viers to get authenticated. Email Scott at scott@gmail.com (placeholder)
            </div>
        </div>
        <div id="step2">
            <h2>Step 2: Contribute Data</h2>
            <div id="content2">
