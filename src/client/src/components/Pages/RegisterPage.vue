        ...
        <form class='register--form' @submit="register">
          ...
          <div class="start" v-if="currentStage == 'start' ">
            ...
            <div class="errors">
              ...
              <ErrorMessage v-if="errors.initEmail" :errorMessage="errors.initEmail" >Please enter a valid Email address.</ErrorMessage>
              <ErrorMessage v-if="errors.email" :errorMessage="errors.email" >Confirmation Email does not match.</ErrorMessage>
              <ErrorMessage v-if="errors.initPassword" :errorMessage="errors.initPassword" >Please enter a valid passord.</ErrorMessage>
              <ErrorMessage v-if="errors.password" :errorMessage="errors.password" >Confirmation password does not match.</ErrorMessage>
            </div>
            <TextInput v-model.trim="registerUserData.name" label="Your Name" inputType="text" :hideShowButton="false" :isError="isError" />
              <TextInput v-model.trim="registerUserData.initEmail" label="Email" inputType="email" :hideShowButton="false" :isError="isError" />
              <TextInput v-model.trim="registerUserData.email" label="Confirm Email" inputType="email" :hideShowButton="false" :isError="isError" />
              <TextInput v-model.trim="registerUserData.initPassword" label="Password" inputTypeProp="password" :hideShowButton="true" :isError="isError" />
              <TextInput v-model.trim="registerUserData.password" label="Confirm Password" inputTypeProp="password" :hideShowButton="true" :isError="isError" />
          <div>
          ...
          <button class="button montserrat-light"><img class="icon" src="../../assets/google.svg"/>Register with Google</button>
          <button class="button montserrat-light"><img class="icon" src="../../assets/linkedin.svg"/>Register with LinkedIn</button>
          </div>
